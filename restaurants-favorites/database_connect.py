...
def getRestosFromNeighborhood(neighborhood_id):
...
def insertUser(user_name, neighborhood_id):
    db_connection = sqlite3.connect('restaurants.db')
    ...
    # run a first query 
    db_cursor.execute("""INSERT INTO users VALUES ('%s', '%s', '%s')
                        """ % (user_name, neighborhood_id, "none"))
